...
faq_questions = [line.strip() for line in faq_data]
...
def get_llm_response(user_query, faq_data=faq_data):
    ...
    # """
    print("invoked) ")
    fewShot_examples = faq_data
    prompt = f"You are a helpful assistant for a chapter at VIT Vellore called IEEE-CS that answers FAQs and engages in conversation with the user. This is the context in the document provided to you:\n{fewShot_examples}\nNow, answer the user's question concisely in 2 lines:\nUser: {user_query}\nYou:"
